...
================================
-run_OGDM_v3.sh (shell script for temporarily setting environment variables and executing 
 the application)
   -to run the shell script, type
   
       ./run_OGDM_v3.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v80, run the shell script as:
       ...
       ./run_OGDM_v3.sh /mathworks/home/application/v80
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_OGDM_v3.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
   -if end users are unable to download the MCR using the above  
    link, include it when building your component by clicking 
    the "Add MCR" link in the Deployment Tool
-The Macintosh bundle directory structure OGDM_v3.app 
   -this can be gathered up using the zip command 
    zip -r OGDM_v3.zip OGDM_v3.app
    or the tar command 
    tar -cvf OGDM_v3.tar OGDM_v3.app
-This readme file 
...
A. Mac systems:
   ...
   the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_OGDM_v3.sh 
